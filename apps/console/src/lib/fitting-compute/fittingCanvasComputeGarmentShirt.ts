...
import { buildShirtPath } from "@/app/(main)/development/fitting/lib/shirtUtils";
import type { MeasureOverlayData, ShirtSize, ShoulderDebug } from "@/app/(main)/development/fitting/lib/types";
import { getAllPathPoints } from "@/app/(main)/development/fitting/lib/fittingContourUtils";
import { interpolatePath } from "@/app/(main)/development/fitting/lib/pathUtils";
import {
  indexOfClosest,
