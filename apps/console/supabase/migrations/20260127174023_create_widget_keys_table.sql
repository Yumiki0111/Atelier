...
-- RLSポリシー（shop_idで分離）
CREATE POLICY "Users can view widget_keys of their shop"
...
CREATE POLICY "Users can create widget_keys in their shop"
...
CREATE POLICY "Users can update widget_keys of their shop"
...
CREATE POLICY "Users can delete widget_keys of their shop"
