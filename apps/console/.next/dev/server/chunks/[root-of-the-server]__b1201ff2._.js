...
async function GET(request, { params }) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("products").select("*").eq("id", id).single();
        if (error) {
...
async function PATCH(request, { params }) {
    try {
        ...
        const validated = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$shared$2f$src$2f$schemas$2f$product$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProductSchema"].parse(body);
        const updateData = {};
        if (validated.shopId !== undefined) updateData.shop_id = validated.shopId;
        ...
        if (validated.handle !== undefined) updateData.handle = validated.handle;
        if (validated.url !== undefined) updateData.url = validated.url;
        if (validated.sizeTypeId !== undefined) updateData.size_type_id = validated.sizeTypeId;
        if (validated.thumbnailUrl !== undefined) updateData.thumbnail_url = validated.thumbnailUrl;
        if (validated.previewImageUrl !== undefined) updateData.preview_image_url = validated.previewImageUrl;
        updateData.updated_at = new Date().toISOString();
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("products").update(updateData).eq("id", id).select().single();
        if (error) {
            if (error.code === "PGRST116") {
                return __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Product not found"
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("products").delete().eq("id", id);
        if (error) {
            if (error.code === "PGRST116") {
                return __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Product not found"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b1201ff2._.js.map