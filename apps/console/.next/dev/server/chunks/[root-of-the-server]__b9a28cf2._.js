...
"[project]/atelier/apps/console/src/app/api/admin/members/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        // 対象メンバーを取得
        const { data: targetMember, error: targetError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").select("shop_id, role").eq("id", id).single();
        ...
        // 権限を更新
        const { data: updatedMember, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").update({
            role
...
async function DELETE(request, { params }) {
    try {
        ...
        const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").delete().eq("id", id);
        if (deleteError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9a28cf2._.js.map