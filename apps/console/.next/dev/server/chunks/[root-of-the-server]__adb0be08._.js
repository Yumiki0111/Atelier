...
"[project]/atelier/apps/console/src/app/api/widget-keys/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const updateWidgetKeySchema = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    allowed_domains: __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)).optional(),
    enabled: __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional()
});
async function PATCH(request, { params }) {
    try {
        ...
        const { data: existingKey, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("widget_keys").select("shop_id").eq("id", id).single();
        ...
        if (validated.allowed_domains !== undefined) {
            ...
            updateData.allowed_domains = validated.allowed_domains.length > 0 ? validated.allowed_domains : [];
        ...
        // 更新
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("widget_keys").update(updateData).eq("id", id).eq("shop_id", auth.shopId).select("id, shop_id, public_key, allowed_domains, enabled, created_at, updated_at").single();
        console.log("[PATCH /api/widget-keys/:id] Update result:", {
            data,
            error
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adb0be08._.js.map