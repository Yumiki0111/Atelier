...
"[project]/atelier/apps/console/src/app/api/auth/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        console.log("[profile API] Authenticated user:", {
            hasAuth: !!auth,
            userId: auth?.userId
        });
        if (!auth) {
        ...
        const { data: userData, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").select("name, email").eq("id", auth.userId).single();
...
async function PATCH(request) {
    try {
        ...
        // profiles テーブルを更新
        const { data: userData, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").update(updateData).eq("id", auth.userId).select("name, email").single();
        if (userError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__357c58b3._.js.map