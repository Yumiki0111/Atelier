...
"[project]/atelier/apps/console/src/app/api/internal/provision-shop/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        console.log("[provision-shop API] Creating shop:", {
            shopName,
            ownerEmail
        });
        // 1. shops を作成
        // shopName が提供されない場合は "新規ショップ" として作成（オンボーディングで設定）
        const { data: shop, error: shopError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("shops").insert({
        ...
        // 2. widget_keys を発行
        const publicKey = `pub_live_${__TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomBytes(16).toString("hex")}`;
        const secretKey = `sec_live_${__TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomBytes(32).toString("hex")}`;
        // secret_key をハッシュ化（bcrypt の代わりに crypto.pbkdf2 を使用）
        const secretKeyHash = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].pbkdf2Sync(secretKey, process.env.SECRET_KEY_SALT || "atelier-salt", 10000, 64, "sha512").toString("hex");
        const { data: widgetKey, error: widgetKeyError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("widget_keys").insert({
            shop_id: shop.id,
        ...
        const { data: invite, error: inviteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("pending_invites").insert({
            shop_id: shop.id,
            email: ownerEmail,
            role: "owner"
        }).select().single();
        ...
        try {
            const { data: inviteData, error: inviteAuthError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].auth.admin.inviteUserByEmail(ownerEmail, {
                data: {
                    shop_id: shop.id,
                    role: "owner"
                },
            ...
            if (inviteAuthError) {
                console.error("[provision-shop API] Error sending invite email:", inviteAuthError);
            // エラーでも続行（招待メールは手動で再送できる）
            } else {
                console.log("[provision-shop API] Invite email sent to:", ownerEmail);
            }
        } catch (emailError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c65d106._.js.map