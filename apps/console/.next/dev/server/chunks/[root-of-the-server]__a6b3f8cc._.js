...
"[project]/atelier/apps/console/src/app/api/debug/conversations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // 会話を取得
        const { data: conversations, error: conversationsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("conversations").select(`
        id,
        shop_id,
        product_id,
        session_id,
        ...
        message_count,
        created_at
      `).eq("shop_id", shopId).order("started_at", {
            ascending: false
        }).limit(limit);
        ...
        const conversationsWithMessages = await Promise.all((conversations || []).map(async (conv)=>{
            const { data: messages, error: messagesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("messages").select("id, role, content, created_at").eq("conversation_id", conv.id).order("created_at", {
                ascending: true
            }).limit(10);
            return {
                ...conv,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6b3f8cc._.js.map