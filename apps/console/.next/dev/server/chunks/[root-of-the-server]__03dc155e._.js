...
async function GET(request) {
    try {
        ...
        let productQuery = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$apps$2f$console$2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("products").select("id, status").eq("shop_id", shopId).eq("status", "published");
        if (productId) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03dc155e._.js.map