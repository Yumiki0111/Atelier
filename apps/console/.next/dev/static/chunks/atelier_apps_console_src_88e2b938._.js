...
function AuthProvider({ children }) {
    _s();
    const [isAuthenticated, setIsAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const shopId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[shopId]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const storedShopId = localStorage.getItem("shopId");
            return storedShopId || "default_shop";
        }
    }["AuthProvider.useMemo[shopId]"], []);
...
_s(AuthProvider, "+qK7CfOK5HMt8pjpRcdAmE6bEog=", false, function() {
    return [
...
//# sourceMappingURL=atelier_apps_console_src_88e2b938._.js.map