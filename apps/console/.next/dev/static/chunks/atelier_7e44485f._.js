...
"[project]/atelier/packages/preview/src/viewer.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function init3DViewer(container, options) {
    ...
    if ('outputColorSpace' in renderer) {
        ...
        // 古いバージョンのThree.js用
        renderer.outputEncoding = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.sRGBEncoding;
    }
    renderer.toneMapping = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.ACESFilmicToneMapping;
    ...
    const ambientLight = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.AmbientLight(0xffffff, 1.2); // 環境光を少し強く
    scene.add(ambientLight);
    const directionalLight1 = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.DirectionalLight(0xffffff, 2.0); // メインライトを強く
    ...
    // 初期のphi（上下回転）を保存して固定
    const initialSpherical = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Spherical();
    ...
    canvasElement.style.cursor = "grab";
    // 地面を追加（影を受けるため）
    const groundGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.PlaneGeometry(20, 20);
    const groundMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.MeshStandardMaterial({
        color: 0xffffff,
        transparent: true,
        opacity: 0 // 透明だが影を受ける
    });
    const ground = new __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Mesh(groundGeometry, groundMaterial);
    ...
    const enableShadow = (object)=>{
        object.traverse((child)=>{
            if (child instanceof __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Mesh) {
                ...
                if (child.material) {
                    ...
                    if ('colorSpace' in material) {
                        ...
                        // 古いバージョンのThree.js用
                        material.encoding = __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.sRGBEncoding;
                    }
                }
            }
        });
...
"[project]/atelier/packages/preview/src/ui-elements.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$src$2f$viewer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/atelier/packages/preview/src/viewer.ts [app-client] (ecmascript)");
...
function initPreviewPanel(options) {
  ...
  `.trim();
    ...
    const viewerElements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$src$2f$ui$2d$elements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createViewerContainer"])(productName);
    ...
    // メッセージ入力エリアを作成
    const messageElements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$src$2f$ui$2d$elements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMessageArea"])();
    ...
    const viewerInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$atelier$2f$packages$2f$preview$2f$src$2f$viewer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["init3DViewer"])(viewerContainer, {
        glbUrl,
        modelUrl,
        textureUrl,
        backgroundImageUrl,
...
//# sourceMappingURL=atelier_7e44485f._.js.map